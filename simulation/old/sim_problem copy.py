...
class GlobalSampler:
    ...
    def __init__(self, total_batches: int, job_ids: List[str], cache:SharedCache, assignment_strategy: str = "shuffle"):
...
if __name__ == "__main__":
    ...
    batch_assignment_strategy = "sequential" # "sequential", "shuffle", "coordinated"
    run_simulation(
        workload_name = workload_name,
        workload_jobs = jobs,
        cache_capacity = cache_capacity,
